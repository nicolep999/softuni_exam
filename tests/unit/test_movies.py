"""
Unit tests for movies app functionality.
"""
...
from movies.forms import MovieForm, MovieSearchForm
...
class MovieModelTest(TestCase):
    ...
    def test_movie_creation(self):
        """Test movie creation and basic fields."""
...
class MovieViewsTest(TestCase):
    """Test movie views functionality."""
    ...
    def test_movie_create_view_requires_staff(self):
        """Test movie create view requires staff permissions."""
    ...
    def test_add_to_watchlist_requires_login(self):
        ...
        response = self.client.get(
            reverse("movies:add_to_watchlist", kwargs={"movie_id": self.movie.pk})
        )
        self.assertEqual(response.status_code, 302)  # Redirect to login
...
class MovieFormsTest(TestCase):
    """Test movie forms functionality."""
    ...
    def test_movie_form_invalid_year(self):
        """Test movie form with invalid year."""
        form_data = {
            "title": "Test Movie",
...
class WatchlistTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username="testuser", password="testpass123")
        self.movie = Movie.objects.create(
            title="Test Movie", release_year=2020, plot="A test movie plot"
        )
